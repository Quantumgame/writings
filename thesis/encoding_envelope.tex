...
\subsection{Linear Filter Encoders Predict 5-30Hz LFP from Amplitude Envelope}
...
the value $\lambda$ is a user-defined hyperparameter, high values of force weights towards zero. 
